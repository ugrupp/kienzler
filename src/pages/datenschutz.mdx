...
sections:
  - type: plain
    ...
    textCol1: |-
      <p textStyle="paragraph-lg"><strong>Wir nehmen den Schutz Ihrer persönlichen Daten sehr ernst</strong> und behandeln Ihre personenbezogenen Daten vertraulich und entsprechend der gesetzlichen Datenschutzvorschriften sowie dieser Datenschutzerklärung.</p>
